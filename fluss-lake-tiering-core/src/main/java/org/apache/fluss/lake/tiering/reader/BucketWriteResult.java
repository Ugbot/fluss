 ...
 * one round of tiering. It'll be passed to the committer to collect all the write results of a
 * table and do commit.
 */
public class BucketWriteResult<WriteResult> {
    ...
    // used for the committer to determine when all write results
    // for the round of tiering is finished
    private final int numberOfWriteResults;

    public BucketWriteResult(
            TablePath tablePath,
